...
const ThumbnailRow = (): JSX.Element => {
  return (
    <Link to="" className={styles["row-thumbnail-item-component"]}>
      ...
      <div className={styles["body"]}>
        <div className={styles["image"]} style={{ backgroundImage: `url(${mockImage})` }} />
        <div className={styles["main"]}>
          ...
          <span className={styles["content"]}>
            커피는 단순한 음료가 아니라 작은 휴식이자 대화의 시작점이다. 갓 갈아낸 원두의 향은 바쁜 일상 속에서 잠시
            멈춤을 선물하고, 뜨거운 에스프레소의 농도는 집중을, 부드러운 라떼의 거품은 위로를 건넨다. 커피는 단순한
            음료가 아니라 작은 휴식이자 대화의 시작점이다. 갓 갈아낸 원두의 향은 바쁜 일상 속에서 잠시 멈춤을 선물하고,
            뜨거운 에스프레소의 농도는 집중을, 부드러운 라떼의 거품은 위로를 건넨다.
          </span>
        </div>
      </div>
    </Link>
